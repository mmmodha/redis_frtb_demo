...
-- (FRTB_PRELUDE). GIRR delta count semantics: every type+exclude pass
-- counts (matches pre-refactor behavior — count increments regardless of
-- whether risk_value parsed).
