// Wave 5.16e2: collate the 9 per-(risk_class × leg) calc replies into a
// single aggregate.json + flat charges table. Pure stdlib; reads from
// docs/recordings/smoke-run-16/calc/. Risk-class totals use the L2 norm
// across legs (Delta/Vega/Curvature) per the SBM additive convention for
// the smoke-run series — this matches smoke-run-15's aggregate shape so
