...
**Total presenter time across setup + 14 beats + closer: 25 + 30 + 40 + 40 + 40 + 25 + 40 + 35 + 35 + 35 + 45 + 35 + 30 + 40 + 25 + 25 = 545 s.** Beats 11–14 add an interactive "Redis push-down" sweep (F1 bucket subset, F2 §21.6 regime, F3 metadata exclusion, Search auto-complete) between the math walkthrough and the closer. Drop Beat 14 (typeahead) when running the 15-min variant — it is the most self-contained moment and the easiest to skip without breaking the narrative arc.
